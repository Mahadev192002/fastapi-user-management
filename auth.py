...
def hash_password(password: str) -> str: # Hash a plain password using the recommended hashing algorithm and return the hashed password
...
# Define a dependency to get the current user based on the provided JWT token,
# using the OAuth2 password bearer scheme for authentication
